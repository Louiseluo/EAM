    ...
    <div class="basic fault-content">
            ...
            <Form ref="order_Form" :model="order_Form" label-position="right" inline :label-width="135" >
               ...
               <!-- <Form-item label="是否停机">
                ...
                <Form-item label="上报计划编码">
                    <Input v-model="order_Form.requiredTime" placeholder="超链接" style="width: 160px;" disabled></Input>
                </Form-item>
                <Form-item label="制单人">
        ...
        <Tabs type="card">
            ...
            <Tab-pane class="checkTab" label="保养项目" icon="social-buffer">
                <Table class="mar-b-15" stripe border :columns="sdColumns" :data="sdTmp"></Table>
            </Tab-pane>
        </Tabs>
        ...
        <div align="center" class="btnGroupDesign">
           <!-- <router-link to="/maintenanceOrder" class="mar-r-20">
            ...
            <!--<Button type="primary"  size="large">保存草稿</Button>-->
            <Button type="primary" size="large" @click="disMaintain">重新派工</Button>
            <!--<Button type="primary" size="large" @click="disMaintain">派发工单</Button>-->
            <!--<Button type="primary" size="large">转设备科长</Button>
            <Button type="primary" size="large" @click="disMaintain">补领备件</Button>-->
        </div>
        <!--图片-->
