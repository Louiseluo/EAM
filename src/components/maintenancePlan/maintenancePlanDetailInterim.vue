    ...
    <div class="basic fault-content">
        ...
        <div class="form-content">
            <Form ref="workForm" :model="planAddForm" label-position="right" inline :label-width="120">
                ...
                <Form-item  label="计划等级" prop="planLevel">
                ...
                <Form-item label="耗时累计（分钟）" prop="requiredTime">
        ...
        <div class="table-content">
            <Form :model="savePlanSchedule" label-position="right" inline :label-width="135">
                <Form-item label="执行时间" prop="firstStartTime">
                    <Date-picker v-model="savePlanSchedule.happenTime" type="date" placeholder="选择日期和时间"  @on-ok="savePlanScheduleHappenTime" confirm disabled></Date-picker>
                </Form-item>
        ...
        <Row class="btn-group">
            <Col class="pad-15" span="24" align="center">
                <router-link to='/maintenancePlan' class="mar-r-15">
                    <Button v-show="button_14412" class="btn-gary" icon="close" size="large">返回</Button>
                </router-link>
...
//                console.log("searchPlanDetail stating ......."+taskId);
            ...
            goPlandDetailEdit() {//计划详情编辑页
                ...
                this.$router.push({path: '/planInterimEdit', query: {"planTaskId": taskId}});
            },
            /************************************   作废   start  ******************************************/
            deletePlan: function () {
                let vm = this;
