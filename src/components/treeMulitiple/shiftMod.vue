<template>
    <div class="basic fault-content">
            <div class="btn-query mar-b-10" style="display: table;margin-bottom: 20px;">
                班次  <Input class="mar-l-10" style="width: 160px;" v-model="shiftName" @on-blur="shiftName = toValidate(shiftName)" ></Input>
...
//                console.log(msg);
            ...
            //部门查询：
            getManuf(){
                this.$axios.get('/System/shiftNameMagnifier', {
                    params: {
                        page: this.page,
            ...
            toSelect(rowdata){
                this.$emit("shiftSelected", rowdata);
            },
            searchList(){
                this.page = 1;
                this.getManuf();
