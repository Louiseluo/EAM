<template>
    <div class="basic fault-content">
            <div class="btn-query mar-b-10" style="display: table;margin-bottom: 20px;">
                部门名称  <Input class="mar-l-10" style="width: 160px;" v-model="department_name" @on-blur="department_name = toValidate(department_name)" ></Input>
...
//                console.log(msg);
            ...
            //部门查询：
            getManuf(){
                this.$axios.get('/System/departmentMagnifier', {
                    params: {
                        page: this.page,
